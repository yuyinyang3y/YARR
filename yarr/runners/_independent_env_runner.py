        ...
        for n_eval in range(self._num_eval_runs):
            ...
            for ep in range(self._eval_episodes):
                ...
                if rec_cfg.enabled:
                    ...
                    record_file = os.path.join(rec_cfg.save_path, 'videos',
                                               '%s_s%s_%s.mp4' % (task_name,
                                                                      eval_demo_seed,
                                                                      'succ' if success else 'fail'))
                    # record_file_prediction = os.path.join(rec_cfg.save_path, 'videos_pd',
                    #                            '%s_s%s_%s.mp4' % (task_name,
                    #                                                   eval_demo_seed,
                    #                                                   'succ' if success else 'fail'))
                    ...
                    # tr.save_prediction(record_file_prediction, lang_goal, reward)
